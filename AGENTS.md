...
| ID | Type | Title | Date |
|----|------|-------|------|
| a8ca377d-dbd2-4de1-a6b5-adc83e6f0628 | 🔵 discovery | Singleton pattern usage in Config and ProcessInfo | 2026-06-14 |

**Key concepts:** singleton pattern, global access, design pattern
