...
## 当前优先级（2026-09-04 执行更新）

> **2026-09-04 执行收口**（按 09-03 计划逐项落地，见 DOC_CHANGELOG）：
> 项 1 基准复测 ✅（none 512MB 554 MB/s 落基线，700 验收线留新机裁决）；
> 项 2 stop 误报 ✅ 验证不复现关闭（回归 case 常驻）；项 5 锁内 IO ✅ 收口
> （StorageManager 快照化 + 析构出锁，commit dd9f0b4）；项 3 ✅ 双根修
> （BEGIN/WBQ 异序 + IO/完整性分类，commit 2af57a5）；项 4 ✅ 批 1-3 落地
> + TSAN 工具链（commit 4490aa9/64a44f1/e9815e9）。新增待办见 issue 011
> （DataServer::stop TSAN 竞态，预存在）与「新机基准裁决」。
