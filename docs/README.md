...
| 运行时性能热点分析（2026-08-31） | [performance-analysis-2026-08-31.md](performance-analysis-2026-08-31.md)（纯传输压测：memset 消除 +8.5%、sendfile 零拷贝 +20%；读写两段并行度确认与三段拆解评估；PeerRpc 直拼帧 + 圈级收集并发化） |
