...
// A declaration of the signature of all callbacks that return a defiPath
// which belongs to a specific defiWire and defiNet.
typedef int (*defrPathInWireCbkFnType) (defrCallbackType_e,
                                        defiPath *,
                                        defiWire *,
                                        defiNet *,
                                        defiUserData);

// A declaration of the signature of all callbacks that return a defiWire
// which belongs to a specific defiNet.
typedef int (*defrWireInNetCbkFnType) (defrCallbackType_e,
                                       defiWire *,
                                       defiNet *,
                                       defiUserData);

// A declaration of the signature of all callbacks that return a defiNetRect
// which belongs to a specific defiNet (only for SPECIAL NETS).
typedef int (*defrRectInNetCbkFnType) (defrCallbackType_e,
                                       defiNetRect *,
                                       defiNet *,
                                       defiUserData);
...
// If set - allows parsing DEF 6.0+, if not set - maximum
// processed version will be DEF 5.8.
extern void defrSetAllowVer60Plus(int allow);
...
extern void defrSetFillPartialCbk (defrFillCbkFnType);
...
extern void defrSetPathInSNetWireCbk (defrPathInWireCbkFnType);
extern void defrSetWireInSNetCbk (defrWireInNetCbkFnType);
extern void defrSetRectInSNetCbk (defrRectInNetCbkFnType);
...
extern void defrUnsetFillPartialCbk ();
...
extern void defrUnsetPathInSNetWireCbk ();
extern void defrUnsetWireInSNetCbk ();
extern void defrUnsetRectInSNetCbk ();
...
// Testing purposes only 
extern void setTotalNumErrorsParsed(int errors);
