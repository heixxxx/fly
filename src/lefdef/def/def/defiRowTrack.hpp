...
public:
  ...
  void setNdr(const char* ndr);                 // 6.0
  void setWidth(double width);                  // 6.0
  ...
  int sameMask() const;
  const char* ndr() const;              // 6.0
  int hasWidth() const;                 // 6.0
  double width() const;                 // 6.0
  int numProps() const;                 // 6.0
  defiProp* prop(int index);            // 6.0
