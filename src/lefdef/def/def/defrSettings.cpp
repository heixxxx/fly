...
defrSettings::init_symbol_table()
{
    ...
    Keyword_set["BLOCKAGE"] = K_BLOCKAGE;
    ...
    Keyword_set["SCANCHAIN"] = K_SCANCHAIN;
    ...
    Keyword_set["SOFTFIXED"] = K_SOFTFIXED;
    ...
    Keyword_set["SPECIALROUTE"] = K_SPECIALROUTE;
