...
EXTERN size_t   defiFill_numRectangles (const defiFill* obj);
EXTERN int      defiFill_xl (const defiFill* obj, size_t index);
EXTERN int      defiFill_yl (const defiFill* obj, size_t index);
EXTERN int      defiFill_xh (const defiFill* obj, size_t index);
EXTERN int      defiFill_yh (const defiFill* obj, size_t index);

EXTERN size_t   defiFill_numPolygons (const defiFill* obj);
EXTERN struct defiPoints defiFill_getPolygon (const defiFill* obj, size_t index);
