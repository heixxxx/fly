...
void lefwSetAntennaInputGateAreaCbk (::lefwVoidCbkFnType p0) {
    LefDefParser::lefwSetAntennaInputGateAreaCbk((LefDefParser::lefwVoidCbkFnType) p0);
}

void lefwSetAntennaInOutDiffAreaCbk (::lefwVoidCbkFnType p0) {
    LefDefParser::lefwSetAntennaInOutDiffAreaCbk((LefDefParser::lefwVoidCbkFnType) p0);
}

void lefwSetAntennaOutputDiffAreaCbk (::lefwVoidCbkFnType p0) {
