...
// 2026-08-16 冗余清理：DataLocationMessageEncodeDecode / DataQueryMessageEncodeDecode
// 的 round-trip 覆盖与 message_protocol_test 的同消息用例重复，已删除；
// 本文件专注 MetadataClient 客户端行为（默认值/失败路径/e2e）。
