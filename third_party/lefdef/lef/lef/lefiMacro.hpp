...
public:
  ...
  void setNumProperty(const char* name, double d, const char* value,
                      char type);
  void addOBSSpacing(const char *type, double spacing);
  void addOBSSpacingLayer(const char* layer);
  void bumpProps();
  ...
  int numOBSSpacings() const;
  const char* OBSSpacingType(int idx) const;
  double OBSSpacingSpacing(int idx) const;
  int numOBSSpacingLayers(int idx) const;
  const char* OBSSpacingLayer(int idx, int layerIdx) const;
