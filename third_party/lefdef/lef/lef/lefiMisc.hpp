...
*/
  ...
  const lefiProp* getProp(int idx) const;
  lefiGeomViaIter* getViaIter(int index) const;
  const char* getObsType(int index) const;
...
public:
  ...
  void addProp(lefiProp* prop);            // 6.0
  ...
  lefiProp* prop(int index) const;           // 6.0
