...
// *****************************************************************************
// Const getters of the defiGeometries class.
// *****************************************************************************
inline int
defiGeometries::numPoints() const
{
    return numPoints_;
}

inline const int*
defiGeometries::x() const
{
    return x_;
}

inline const int*
defiGeometries::y() const
{
    return y_;
}
