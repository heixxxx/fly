...
EXTERN void lefwSetAntennaInputGateAreaCbk (lefwVoidCbkFnType p0);
EXTERN void lefwSetAntennaInOutDiffAreaCbk (lefwVoidCbkFnType p0);
EXTERN void lefwSetAntennaOutputDiffAreaCbk (lefwVoidCbkFnType p0);
