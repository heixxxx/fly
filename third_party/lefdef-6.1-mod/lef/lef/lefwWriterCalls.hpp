...
extern void lefwSetAntennaInputGateAreaCbk(lefwVoidCbkFnType);
extern void lefwSetAntennaInOutDiffAreaCbk(lefwVoidCbkFnType);
extern void lefwSetAntennaOutputDiffAreaCbk(lefwVoidCbkFnType);
