...
public:
  ...
  void setMinSize(lefiGeometries* geom);             // 6.0
  void setManufacturingGrid(double value);           // 6.0
  ...
  int    hasManufacturingGrid() const;    // 6.0
  double manufacturingGrid() const;       // 6.0
...
protected:
  ...
  int     hasManufacturingGrid_;
  double  manufacturingGrid_;
};
