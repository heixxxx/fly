...
class  lefrPropArray : public std::vector<lefiProp*>
{
public:
    lefrPropArray() {};
    ~lefrPropArray() {
...
public:
    ...
    static void reset();
    void        initRead();
    int         lef60NewSyntaxError(const char* address);
    int         lef60ObsoltedError(const char* address);
    int         lef60SyntaxError(const char* rule);
    void        setPropDataType(lefiProp*       prop,
