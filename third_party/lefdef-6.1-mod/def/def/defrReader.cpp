...
typeToString(defrCallbackType_e num)
{
    ...
    case defrExtensionCbkType:
        return "Extension";
    case defrPathInWireCbkType:
        return "Path in Wire";
    case defrWireInNetCbkType:
        return "Wire in Net";
    case defrRectInNetCbkType:
        return "Rect in Net";
...
void
defrUnsetFillPartialCbk()
{
    DEF_INIT;
    defContext.callbacks->FillPartialCbk = NULL;
}
...
void
defrUnsetPathInSNetWireCbk()
{
    DEF_INIT;
    defContext.callbacks->PathInSNetWireCbk = NULL;
}

void
defrUnsetWireInSNetCbk()
{
    DEF_INIT;
    defContext.callbacks->WireInSNetCbk = NULL;
}

void
defrUnsetRectInSNetCbk()
{
    DEF_INIT;
    defContext.callbacks->RectInSNetCbk = NULL;
}
...
// TODO: FillPartialCbk is implemented only for FILLS LAYER RECTs and POLYGONs.
//       It is not implemented for FILLS VIA.
void
defrSetFillPartialCbk(defrFillCbkFnType f)
{
    DEF_INIT;
    defContext.callbacks->FillPartialCbk = f;
}
...
void
defrSetPathInSNetWireCbk(defrPathInWireCbkFnType f)
{
    DEF_INIT;
    defContext.callbacks->PathInSNetWireCbk = f;
}

void
defrSetWireInSNetCbk(defrWireInNetCbkFnType f)
{
    DEF_INIT;
    defContext.callbacks->WireInSNetCbk = f;
}

void
defrSetRectInSNetCbk(defrRectInNetCbkFnType f)
{
    DEF_INIT;
    defContext.callbacks->RectInSNetCbk = f;
}
...
void
defrSetTotalNumErrorsParsed(int totNumErrors)
{
    DEF_INIT;
    defContext.settings->totalNumErrorsParsed = totNumErrors;
}
...
void 
defrSetAllowVer60Plus(int allow)
{
    DEF_INIT;
    defContext.settings->AllowVer60Plus = allow;
}
...
void defrSetRemoveBackslash(int remove) {
