...
typedef enum {
  ...
  defrNetPartialPathCbkType = 21,
  defrPathCbkType = 22,
  defrVersionCbkType = 23,
  defrVersionStrCbkType = 24,
  defrComponentExtCbkType = 25,
  defrPinExtCbkType = 26,
  defrViaExtCbkType = 27,
  defrNetConnectionExtCbkType = 28,
  defrNetExtCbkType = 29,
  defrGroupExtCbkType = 30,
  defrScanChainExtCbkType = 31,
  defrIoTimingsExtCbkType = 32,
  defrPartitionsExtCbkType = 33,
  defrHistoryCbkType = 34,
  defrDieAreaCbkType = 35,
  defrCanplaceCbkType = 36,
  defrCannotOccupyCbkType = 37,
  defrPinCapCbkType = 38,
  defrDefaultCapCbkType = 39,
  defrStartPinsCbkType = 40,
  defrPinCbkType = 41,
  defrPinEndCbkType = 42,
  defrRowCbkType = 43,
  defrTrackCbkType = 44,
  defrGcellGridCbkType = 45,
  defrViaStartCbkType = 46,
  defrViaCbkType = 47,
  defrViaEndCbkType = 48,
  defrRegionStartCbkType = 49,
  defrRegionCbkType = 50,
  defrRegionEndCbkType = 51,
  defrSNetStartCbkType = 52,
  defrSNetCbkType = 53,
  defrSNetPartialPathCbkType = 54,
  defrSNetWireCbkType = 55,
  defrSNetEndCbkType = 56,
  defrGroupsStartCbkType = 57,
  defrGroupNameCbkType = 58,
  defrGroupMemberCbkType = 59,
  defrGroupCbkType = 60,
  defrGroupsEndCbkType = 61,
  defrAssertionsStartCbkType = 62,
  defrAssertionCbkType = 63,
  defrAssertionsEndCbkType = 64,
  defrConstraintsStartCbkType = 65,
  defrConstraintCbkType = 66,
  defrConstraintsEndCbkType = 67,
  defrScanchainsStartCbkType = 68,
  defrScanchainCbkType = 69,
  defrScanchainsEndCbkType = 70,
  defrIOTimingsStartCbkType = 71,
  defrIOTimingCbkType = 72,
  defrIOTimingsEndCbkType = 73,
  defrFPCStartCbkType = 74,
  defrFPCCbkType = 75,
  defrFPCEndCbkType = 76,
  defrTimingDisablesStartCbkType = 77,
  defrTimingDisableCbkType = 78,
  defrTimingDisablesEndCbkType = 79,
  defrPartitionsStartCbkType = 80,
  defrPartitionCbkType = 81,
  defrPartitionsEndCbkType = 82,
  defrPinPropStartCbkType = 83,
  defrPinPropCbkType = 84,
  defrPinPropEndCbkType = 85,
  defrBlockageStartCbkType = 86,
  defrBlockageCbkType = 87,
  defrBlockageEndCbkType = 88,
  defrSlotStartCbkType = 89,
  defrSlotCbkType = 90,
