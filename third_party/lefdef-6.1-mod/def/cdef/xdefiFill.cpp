...
size_t defiFill_numRectangles (const ::defiFill* obj) {
    return ((LefDefParser::defiFill*)obj)->numRectangles();
}

int defiFill_xl (const ::defiFill* obj, size_t  index) {
    return ((LefDefParser::defiFill*)obj)->xl(index);
}

int defiFill_yl (const ::defiFill* obj, size_t  index) {
    return ((LefDefParser::defiFill*)obj)->yl(index);
}

int defiFill_xh (const ::defiFill* obj, size_t  index) {
    return ((LefDefParser::defiFill*)obj)->xh(index);
}

int defiFill_yh (const ::defiFill* obj, size_t  index) {
    return ((LefDefParser::defiFill*)obj)->yh(index);
}

size_t defiFill_numPolygons (const ::defiFill* obj) {
    return ((LefDefParser::defiFill*)obj)->numPolygons();
}

::defiPoints defiFill_getPolygon (const ::defiFill* obj, size_t index) {
    udefiPoints tmp;
